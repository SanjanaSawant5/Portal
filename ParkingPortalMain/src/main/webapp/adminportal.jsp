...
try
{
	...
	Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/dropdown","root","Intern@1234");
	Statement stm = conn.createStatement();
	ResultSet rs =  stm.executeQuery("SELECT DISTINCT id, unit, propertycode from propertylist where propertycode="+Integer.parseInt(request.getParameter("cmbProperty")));
...
{
	Class.forName("com.mysql.cj.jdbc.Driver").newInstance();
	Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/dropdown","root","Intern@1234");
	Statement stmt = con.createStatement();
	ResultSet resultset =  stmt.executeQuery("SELECT * FROM propertylist WHERE propertycode="+Integer.parseInt(request.getParameter("cmbProperty")));
